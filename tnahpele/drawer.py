...
def draw_canvas_border(canvas, vertical_char, horizontal_char):
    ...
    line(canvas, 0, 1, 0, max_y-1, vertical_char)  # left vert
    line(canvas, max_x, 1, max_x, max_y-1, vertical_char)  # right vert
    line(canvas, 0, 0, max_x, 0, horizontal_char)  # top horiz
...
def draw_rectangle(canvas, x1, y1, x2, y2, point_char):
    ...
    draw_line(canvas, x1, y2, x2, y2, point_char)  # bottom horiz
